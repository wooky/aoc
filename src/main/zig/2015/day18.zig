...
const LightMap = struct {
    ...
    const bounds = aoc.CoordRange.initWithBounds(aoc.Coord.fromRowCol(0, 0), aoc.Coord.fromRowCol(99, 99));
    ...
    fn makeDefective(self: *LightMap) !void {
        try self.activate(aoc.Coord.fromRowCol(0, 0));
        try self.activate(aoc.Coord.fromRowCol(0, 99));
        try self.activate(aoc.Coord.fromRowCol(99, 0));
        try self.activate(aoc.Coord.fromRowCol(99, 99));
    }
};
