...
package AOC.AOC_2019.Day01.Day_01_Test_Data is

--  begin read only
   type Test_Day_01 is new
     GNATtest_Generated.GNATtest_Standard.AOC.Test_Data.Tests.Day.Day_Test_Data.Day_Tests.Test_Day
--  end read only
   with null record;

   procedure Set_Up (Gnattest_T : in out Test_Day_01);
   procedure Tear_Down (Gnattest_T : in out Test_Day_01);
